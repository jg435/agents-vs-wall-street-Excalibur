...
def build():
    ...
    FORMULAS = [
        ...
        ("ADI", "Revenue", "guide mid × (1 + measured beat-vs-guide) — weight study superseded the 0.8 rule for ADI",
         "3,900×(1+3.5%) ≈ 4,037; band route 3,994 → 4,000", 4000),
        ("ADI", "Adjusted diluted EPS", "cons × (1 + measured beat alpha) — 22/24 beats, OOS −65%",
         "3.33×1.0560", 3.52),
