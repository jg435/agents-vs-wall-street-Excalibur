...
writing a line of code. The ledger of what we used and rejected:</p>
<div style="overflow-x:auto"><table>
<tr><th>Paper</th><th>What we took</th><th>Status</th></tr>
<tr><td>FinRobot <span class="src">arXiv:2411.08804</span></td>
<td>the 3-layer pipeline shape (evidence → forecast → quality). Explicitly did
...
its features. Leak removed: linear ≈ ML ≈ analysts</td><td class="warn">rejected</td></tr>
</table></div>
...
<p>The underlying edges the design rests on: the walk-down /
post-earnings-announcement drift (the ~75% beat rate — consensus is
systematically low) and SUE, the persistence of a firm's beat/miss habit
